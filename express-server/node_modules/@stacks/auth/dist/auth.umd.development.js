(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@stacks/common'), require('cross-fetch/polyfill'), require('jsontokens'), require('@stacks/encryption'), require('query-string'), require('@stacks/profile'), require('@stacks/network')) :
  typeof define === 'function' && define.amd ? define(['exports', '@stacks/common', 'cross-fetch/polyfill', 'jsontokens', '@stacks/encryption', 'query-string', '@stacks/profile', '@stacks/network'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@stacks/auth'] = {}, global.common, null, global.jsontokens, global.encryption, global.queryString, global.profile, global.network));
}(this, (function (exports, common, polyfill, jsontokens, encryption, queryString, profile, network) { 'use strict';
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (!coreNode) {
                  ...
                  coreNode = network$1.bnsLookupUrl;
                }
...
//# sourceMappingURL=auth.umd.development.js.map
